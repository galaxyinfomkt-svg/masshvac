  ...
  return (
    <>
      ...
      <section className="relative pt-28 pb-16 md:pt-40 md:pb-24 overflow-hidden">
        <Image src="https://assets.cdn.filesafe.space/sZJvTMNScvm4zh9WxYtH/media/699885315ba498e66200370c.jpg" alt="HVAC services across Massachusetts" fill className="object-cover object-center" priority quality={85} />
