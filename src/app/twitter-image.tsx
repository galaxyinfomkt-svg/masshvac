      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: "36px" }}>
            {[0, 1, 2, 3, 4].map((i) => (
              <span key={i} style={{ fontSize: "30px", color: "#CC0000", marginRight: "4px" }}>★</span>
            ))}
            <span style={{ fontSize: "22px", color: "white", fontWeight: 700, marginLeft: "12px" }}>
          ...
          >
            <span style={{ fontSize: "30px", color: "white", fontWeight: 800, letterSpacing: "1px" }}>
              (508) 740-4113
            </span>
          </div>

          <div style={{ fontSize: "17px", color: "rgba(255,255,255,0.45)", textAlign: "center" }}>
